...
local bundles = {
    vim.fn.glob(
        "/Users/U127215/javaDebug/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.45.0.jar",
        1),
};

-- This is the new part
vim.list_extend(bundles, vim.split(vim.fn.glob("/Users/U127215/javaDebug/vscode-java-test/server/*.jar", 1), "\n"))
...
local config = {
    ...
    cmd = {
        ...
        -- 💀
        '-jar',
        '/Users/U127215/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
        ...
        -- 💀
        '-configuration', '/Users/U127215/.local/share/nvim/mason/packages/jdtls/config_mac',
        -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
